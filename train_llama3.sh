...
NVIDIA_SMI_PID=$!
torchrun --nproc_per_node 8 training_llama3_8b.py --model_name meta-llama/Llama-3.1-8B-Instruct --sequence_length 2048 --micro_batch_size 4 --global_batch_size 512 --bf16 --output_dir ./ --train_steps 2000 &
TRAINING_PID=$!
